...
/**
 * This is the item provider adapter for a {@link dataoriented_ishikawa_model.Cause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CauseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cause_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cause_name_feature", "_UI_Cause_type"),
				 Dataoriented_ishikawa_modelPackage.Literals.CAUSE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addRealizesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cause_realizes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cause_realizes_feature", "_UI_Cause_type"),
				 Dataoriented_ishikawa_modelPackage.Literals.CAUSE__REALIZES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
