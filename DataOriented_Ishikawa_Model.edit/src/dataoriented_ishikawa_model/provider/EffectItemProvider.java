...
/**
 * This is the item provider adapter for a {@link dataoriented_ishikawa_model.Effect} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EffectItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Effect_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Effect_name_feature", "_UI_Effect_type"),
				 Dataoriented_ishikawa_modelPackage.Literals.EFFECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDataFeederPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Effect_dataFeeder_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Effect_dataFeeder_feature", "_UI_Effect_type"),
				 Dataoriented_ishikawa_modelPackage.Literals.EFFECT__DATA_FEEDER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Dataoriented_ishikawa_modelPackage.Literals.EFFECT__CATEGORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Dataoriented_ishikawa_modelPackage.Literals.EFFECT__CATEGORIES,
				 Dataoriented_ishikawa_modelFactory.eINSTANCE.createCategory()));
	}
